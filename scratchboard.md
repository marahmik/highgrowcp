...
> 마지막 갱신: 2026-04-08 (Phase 7 보안 패치 반영)
...
- ✅ **관리자 대시보드 매장별 캘린더 복원**: 관리자 통합 캘린더에서 매장별 독립 그리드 표시.

#### Phase 7 — RLS 보안 강화 및 크로스 매장 접근 정책 (2026-04-08)
...
- ✅ **`stores` RLS 보강**: UPDATE/DELETE에 `is_super_admin()` OR `owner_id` 조건 추가.
